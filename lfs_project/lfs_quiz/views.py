...
class QuizDetailView(DetailView):
    ...
    def get(self, request, *args, **kwargs):
        self.object = get_object_or_404(Quiz, module=self.kwargs['moduleid'])
...
class QuizUserProgressView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['mod_scores'] = progress.list_all_mod_scores
...
class QuizTake(FormView):
    ...
    def dispatch(self, request, *args, **kwargs):
        self.quiz = get_object_or_404(Quiz, module=self.kwargs['moduleid'])
    ...
    def get_context_data(self, **kwargs):
        ...
        if hasattr(self, 'progress'):
            ...
            context['percent'] = "{:.0f}".format(self.progress[0]/float(self.progress[1])*100)
        return context
