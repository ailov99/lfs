...
urlpatterns = patterns('',
        ...
        #url(r'^admin_guide/$', TemplateView.as_view(admin_guide="admin_guide.html")),
        url(r'^subscription/(?P<userid>[\w\-]+)$', views.user_subscription, name="subscription"),
        url(r'^change_password/$', views.change_password, name="change_password"),
        url(r'^update_progress/(?P<moduleid>[\w\-]+)/(?P<pagenum>[\w\-]+)$', views.update_progress, name="update_progress"),
        ...
        url(r'^module/(?P<moduleid>[\w\-]+)/quiz/$', view=QuizDetailView.as_view(), name='quiz_start_page'),
