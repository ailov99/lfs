...
class UserForm(forms.ModelForm):
    ...
    terms = forms.BooleanField(required=True, error_messages={'required': 'You must accept the terms and conditions'},
...
class TeacherForm(forms.ModelForm):
    ...
    leaderboard = forms.BooleanField(required=False,
                                     label="I allow my information (name, age-range, location, progress) to be shown in the leaderboard")
